...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/home/index.vue?vue&type=template&id=28ef5b85&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home-page"},[_vm._ssrNode("<div class=\"banner\"><div class=\"container\"><h1 class=\"logo-font\">拉勾教育</h1> <p>A place to share your knowledge.</p></div></div> "),_vm._ssrNode("<div class=\"container page\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-md-9\">","</div>",[_vm._ssrNode("<div class=\"feed-toggle\">","</div>",[_vm._ssrNode("<ul class=\"nav nav-pills outline-active\">","</ul>",[(_vm.user)?_vm._ssrNode("<li class=\"nav-item\">","</li>",[_c('nuxt-link',{staticClass:"nav-link",class:{
              ...
              }}},[_vm._v("\n                "+_vm._s(article.author.username)+"\n              ")]),_vm._ssrNode(" <span class=\"date\">"+_vm._ssrEscape(_vm._s(_vm._f("date")(article.createdAt)))+"</span>")],2),_vm._ssrNode(" <button"+(_vm._ssrAttr("disabled",article.favoriteDisabled))+(_vm._ssrClass("btn btn-outline-primary btn-sm pull-xs-right",{
...
// CONCATENATED MODULE: ./pages/home/index.vue?vue&type=template&id=28ef5b85&
...
/* harmony default export */ var homevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const tag = query.tag;
    const loadArticles = tab === 'global_feed' ? api_article["e" /* getArticles */] : api_article["g" /* getYourFeedArticles */];
    console.log("tab", tab);
    console.log("tag", tag);
    const [articleRes, tagRes] = await Promise.all([loadArticles({
      ...
      offset: (page - 1) * limit,
      tag
    }), getTags()]); //console.log(articleRes.data);
